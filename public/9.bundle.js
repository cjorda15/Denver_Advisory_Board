webpackJsonp([9],Array(161).concat([
/* 161 */
...
var _reactSizeme = __webpack_require__(396);

var _reactSizeme2 = _interopRequireDefault(_reactSizeme);

var _reactStackGrid = __webpack_require__(435);
...
var _EventCard = __webpack_require__(484);

var _EventCard2 = _interopRequireDefault(_EventCard);

var _reactSvg = __webpack_require__(172);
  ...
  _createClass(Events, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('/api/v1/events', {
        ...
        _this2.props.handleGatherEvents(events);
      }).catch(function (err) {
    ...
    value: function handleOnClick(e) {
      (0, _jquery2.default)(e).parents('.event-card-container').find('.event-close').toggle();
      this.grid.updateLayout();
      (0, _jquery2.default)(e).toggleClass('open-event-card-container-open');
    }
  }, {
    key: 'toggleEvent',
    ...
    value: function renderEvents() {
      ...
      if (this.props.events) {
        var sortedEvents = this.props.events.sort(function (a, b) {
          return new Date(a.date) - new Date(b.date);
        });

        return sortedEvents.map(function (eventData, index) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'event-svg-intro-wrapper' },
          _react2.default.createElement(_reactSvg2.default, { path: 'calendar.svg', style: { width: 250 } })
        ),
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)((0, _reactSizeme2.default)()(Events));
...
var SVGInjector = isBrowser ? __webpack_require__(176) : undefined;
...
var h=__webpack_require__(8),n=__webpack_require__(0),aa=__webpack_require__(5),t=__webpack_require__(13),ba=__webpack_require__(66),ca=__webpack_require__(171);
...
;(function (global, factory) {
    true ? factory(__webpack_require__(168)) :
...
var _sizeMe = __webpack_require__(413);
...
var _easyCssTransformBuilder = __webpack_require__(473);
...
var _debounce = __webpack_require__(397);

var _debounce2 = _interopRequireDefault(_debounce);

var _resizeDetector = __webpack_require__(423);
...
var baseGetTag = __webpack_require__(419),
...
var Symbol = __webpack_require__(399),
    getRawTag = __webpack_require__(420),
    objectToString = __webpack_require__(421);
...
var _elementResizeDetector = __webpack_require__(424);
...
var forEach                 = __webpack_require__(400).forEach;
...
var browserDetector         = __webpack_require__(401);
var batchProcessorMaker     = __webpack_require__(430);
var stateHandler            = __webpack_require__(432);

//Detection strategies.
var objectStrategyMaker     = __webpack_require__(433);
var scrollStrategyMaker     = __webpack_require__(434);
...
var _StackGrid = __webpack_require__(436);

var _StackGrid2 = _interopRequireDefault(_StackGrid);

var _easings2 = __webpack_require__(411);

var _easings = _interopRequireWildcard(_easings2);

var _transitions2 = __webpack_require__(412);
...
var _TransitionGroup = __webpack_require__(437);
...
var _GridItem = __webpack_require__(440);

var _GridItem2 = _interopRequireDefault(_GridItem);

var _styleHelper = __webpack_require__(404);

var _requestAnimationFrame = __webpack_require__(410);

var _easings = __webpack_require__(411);
...
var imagesLoaded = _exenv2.default.canUseDOM ? __webpack_require__(482) : null;
...
var _chainFunction = __webpack_require__(438);
...
var _ChildMapping = __webpack_require__(439);
...
var _cursor = __webpack_require__(447);

var _cursor2 = _interopRequireDefault(_cursor);

var _crossFade = __webpack_require__(448);
...
var _flex = __webpack_require__(450);
...
var _imageSet = __webpack_require__(453);
...
var _static = __webpack_require__(458);

var _static2 = _interopRequireDefault(_static);

var _dynamicData = __webpack_require__(472);
...
var _prefixValue = __webpack_require__(407);
...
var _hyphenateProperty = __webpack_require__(408);
...
var _createPrefixer = __webpack_require__(459);

var _createPrefixer2 = _interopRequireDefault(_createPrefixer);

var _staticData = __webpack_require__(461);

var _staticData2 = _interopRequireDefault(_staticData);

var _cursor = __webpack_require__(462);

var _cursor2 = _interopRequireDefault(_cursor);

var _crossFade = __webpack_require__(463);

var _crossFade2 = _interopRequireDefault(_crossFade);

var _filter = __webpack_require__(464);

var _filter2 = _interopRequireDefault(_filter);

var _flex = __webpack_require__(465);
...
var _imageSet = __webpack_require__(468);
...
var _prefixProperty = __webpack_require__(460);
...
var _createCssTransformBuilder = __webpack_require__(474);

var _createCssTransformBuilder2 = _interopRequireDefault(_createCssTransformBuilder);

var _properties2 = __webpack_require__(409);
...
var _properties = __webpack_require__(409);
...
var _EventCarousel = __webpack_require__(488);
...
var EventCard = function EventCard(_ref) {
  var user = _ref.user,
      ...
      participantsList = _ref.participantsList;

  var determineAttendence = function determineAttendence() {
    if (!user) {
      return 'Attend Event';
    }
    var participantsList = eventData.participants.map(function (participant) {
      return participant._id;
    });
    return participantsList.includes(user.userID._id) ? 'Unattend Event' : 'Attend Event';
  };

  var classNameCardTop = function classNameCardTop() {
    if (!user) {
    ...
    return participantsList.includes(user.userID._id) ? 'active-event-card' : 'not-active-event-card';
  };

  var presentParticipants = function presentParticipants() {
    return eventData.participants.length ? _react2.default.createElement(
      'div',
      { className: 'attendeance-cards-container' },
      _react2.default.createElement(
        'div',
        { className: 'attendance-parcipants-container' },
        _react2.default.createElement(
          'div',
          { className: 'attendance-parcipants-count' },
          'Participants:',
          eventData.participants.length
        ),
        eventData.participants.map(function (person, index) {
          return _react2.default.createElement(
            'div',
            { className: 'attendee-basic-summary', key: index },
            _react2.default.createElement(
              'div',
              { className: 'attendee-basic-summary-content' },
              _react2.default.createElement('img', { className: 'attendee-image', src: person.image.url }),
              _react2.default.createElement(
                'p',
                null,
                ' ',
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      { className: 'event-card-top ' + classNameCardTop() },
      _react2.default.createElement(
        'div',
        {
        ...
        _react2.default.createElement('span', { className: 'open-event-click-line-1' }),
        _react2.default.createElement('span', { className: 'open-event-click-line-2' }),
        _react2.default.createElement('span', { className: 'open-event-click-line-3' })
      ),
      _react2.default.createElement(
        'div',
        { className: 'event-basic-info-container' },
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_EventCarousel2.default, { presentation: eventData.images }),
      _react2.default.createElement(
        'div',
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./events.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/autoprefixer-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./events.scss");
...
$(document).ready(function () {
  ...
  $(document).on('click', '.open-event-click-open-btn', function () {
    ...
    $(this).find('.open-event-click-line-2').toggleClass('close-event-line-2');
    $(this).find('.open-event-click-line-3').toggleClass('close-event-line-3');
  });
});
  ...
  _createClass(EventCarousel, [{
    ...
    value: function showButtons() {
      ...
      return this.state.files.length <= 1 ? null : _react2.default.createElement(
        'div',
        { className: 'event-change-presentation-btn-container' },
        _react2.default.createElement(
          'button',
          {
